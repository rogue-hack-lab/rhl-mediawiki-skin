...
class SkinRhlSkin extends SkinTemplate {
	/** Using rhlskin. */
	var $skinname = 'rhlskin', $stylename = 'rhlskin',
		$template = 'RhlSkinTemplate', $useHeadElement = true;
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addModuleStyles( 'skins.rhlskin' );
 ...
 * @ingroup Skins
 */
class RhlSkinTemplate extends BaseTemplate {
...
<?php
	 ...
	 * Shared between RhlSkin and Modern
	 */
	function cactions() {
?>
